...
{
  public class TarArchiveListViewItem : FileListViewItem
  {
    #region CONSTRUCTORS

    public TarArchiveListViewItem( AbstractFile file, AbstractTreeViewNode parentNode )
      : this( file, parentNode, string.Empty )
    {
    }

    public TarArchiveListViewItem( AbstractFile file, AbstractTreeViewNode parentNode, string displayText )
    ...
    public override void Create()
    {
      ...
      AbstractTreeViewNode node = new TarArchiveTreeViewNode( this.File, this.ListView );
    ...
    public override void Delete( bool confirmDelete )
    {
      ...
      if( confirmDelete )
      {
        ...
        string caption = "Confirm Tar Archive Delete";

        if( itemIsReadonly )
          message = string.Format( "The Tar archive '{0}' is a read-only file. Are you sure you want to delete it?", m_item.Name );
    ...
    protected override void FillData()
    {
      ...
      // Type
      string type = typeof( Xceed.Tar.TarArchive ).ToString();

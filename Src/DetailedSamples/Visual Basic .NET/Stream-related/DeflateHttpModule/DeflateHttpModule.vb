'
' Xceed Zip for .NET - Deflate HTTP module 
...
Namespace Xceed.Compression.Samples.DeflateHttpModule
  Public Class DeflateHttpModule
    ...
    Public Sub OnBeginRequest(ByVal sender As Object, ByVal e As EventArgs)
      ...
      ' to see if it supports the deflate encoding. Both Internet Explorer and Netscape
      ...
      Or (encodings.ToLower().IndexOf("deflate") < 0) Then
        ' We can't deflate, too bad
        Exit Sub
      End If

      ' Great, the client supports the "deflate" encoding. We create ourself a new
      ...
      app.Response.Filter = New CompressedStream(app.Response.Filter)

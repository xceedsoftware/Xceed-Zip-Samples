...
Namespace Xceed.FileSystem.Samples.Utils.ListView
  Public Class TarArchiveListViewItem : Inherits FileListViewItem
    #Region "CONSTRUCTORS"
...
#End Region     ' CONSTRUCTORS
    ...
    Public Overrides Sub Create()
      ...
      Dim node As AbstractTreeViewNode = New TarArchiveTreeViewNode(Me.File, Me.ListView)
    ...
    Public Overrides Sub Delete(ByVal confirmDelete As Boolean)
      ...
      If confirmDelete Then
        ...
        Dim caption As String = "Confirm Tar Archive Delete"
    ...
    Protected Overrides Sub FillData()
      ...
      ' Type
      Dim type As String = GetType(Xceed.Tar.TarArchive).ToString()

...
namespace SynchronizeUISample.CustomListViewItem
{
  ...
  /// </summary>
  public class FolderListViewItem : AbstractPathListViewItem
  {
    ...
    public FolderListViewItem( string folderPath)
      : base( folderPath, 0 )
    {
      this.Text = Path.GetDirectoryName( this.m_fullPath );

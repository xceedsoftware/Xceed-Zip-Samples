...
Namespace Xceed.FileSystem.Samples.Utils.TreeView
  Public Class TarArchiveTreeViewNode : Inherits AbstractTreeViewNode
    #Region "CONSTRUCTORS"
    ...
    Public Overrides Sub InitializeFolder()
      If Not m_tarArchive Is Nothing Then
        Return
      End If

      Try
        m_tarArchive = New TarArchive(CType(IIf(TypeOf m_item Is AbstractFile, m_item, Nothing), AbstractFile))
      Catch e1 As InvalidTarStructureException
      ...
      Catch e2 As FileSystemNotSupportedException
    ...
    Private m_tarArchive As TarArchive ' = null

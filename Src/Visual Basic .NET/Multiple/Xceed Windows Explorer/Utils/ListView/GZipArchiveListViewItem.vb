...
Namespace Xceed.FileSystem.Samples.Utils.ListView
  Public Class GZipArchiveListViewItem : Inherits FileListViewItem
    #Region "CONSTRUCTORS"
...
#End Region     ' CONSTRUCTORS
    ...
    Public Overrides Sub Create()
      ...
      Dim node As AbstractTreeViewNode = New GZipArchiveTreeViewNode(Me.File, Me.ListView)
    ...
    Public Overrides Sub Delete(ByVal confirmDelete As Boolean)
      ...
      If confirmDelete Then
        ...
        Dim caption As String = "Confirm GZip Archive Delete"
    ...
    Public Overrides Sub Rename(ByVal name As String)
      ...
      Dim originalName As String = Me.File.Name
    ...
    Protected Overrides Sub FillData()
      ...
      ' Type
      Dim type As String = GetType(Xceed.GZip.GZipArchive).ToString()
      Me.SubItems.Add(type)

      ' Modification date
      Dim modifiedDateFormatted As String = "N/A"

      If Me.File.HasLastWriteDateTime Then
        modifiedDateFormatted = Me.File.LastWriteDateTime.ToString(DateTimeFormatInfo.CurrentInfo.ShortDatePattern & " " & DateTimeFormatInfo.CurrentInfo.ShortTimePattern)
      End If
